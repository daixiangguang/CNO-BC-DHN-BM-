function [pbest_objectives]=QAPPSOHopfieldPal(X,options,stopNum)
...
zbest=inf;
pbest_objectives=single(gpuArray(zeros(maxgen,sizepop)));
flag=single(gpuArray(ones(1,sizepop)));
for i = 1:maxgen
    [tx]=DiscreteHopfieldParallel11(m,initial_x,const1,const2,const3,1000);
