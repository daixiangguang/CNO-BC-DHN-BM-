...
%{
for it=1:10
    y1(1,it)=find_unstop_point(y_N_64{it},M(1));
    y1(2,it)=find_unstop_point(y_N_64{it},M(2));
    y1(3,it)=find_unstop_point(y_N_64{it},M(3));
    y1(4,it)=find_unstop_point(y_N_64{it},M(4));
end
%}
