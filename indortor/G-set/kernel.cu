...
int Hopfield_syn_cuda(double *fea,double *y,double *gbestx,double *initialx)
{
	...
	int *indexd, *indexh;
	double *sd1, *sd2, *sh1, *sh2, *Id1, *Id2, *Ih1, *Ih2, *td, *th, *dd;
	double *objd, *objh;
	...
	cudaMemcpy(dd, fea, sizeof(double) * N*N, cudaMemcpyHostToDevice);
