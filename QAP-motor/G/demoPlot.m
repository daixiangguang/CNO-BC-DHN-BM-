N=[1 4 8 16 32]; %种群个数
M=[100 200 300 400];%不动点个数
yb=combine(N);
boxplot(yb','Whisker',100000,'symbol',' ','whis',2);
% N=[1 4 8 16 32]; %种群个数
%  set(gca,'xticklabels',{ str11});%id=1
% 10 100 200 300
%ylim([-2450,-1350]);
set(gca,'xticklabels',{ 'N=1','M=100', '200', '300', '400','M=100', '200', '300', '400','M=100', '200', '300', '400','M=100', '200', '300', '400','700'});%id=3
