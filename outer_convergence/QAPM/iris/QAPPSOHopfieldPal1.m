function [l,y]=QAPPSOHopfieldPal1(X,options)
...
stopNum=1000;
for i = 1:maxgen
    [tx]=DiscreteHopfieldParallel(alpha,beta,u,n,p,sizepop,d,initial_x,I1,I2,2000);
...
%obj=[];
m=single(gpuArray(zeros(n,sizepop*p)));m=single(gpuArray(m));
